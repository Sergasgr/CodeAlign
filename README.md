...
This project was developed as a technical proposal for the `JetBrains Internship: Post-Training Coding LLMs with Frontier Alignment Methods`. It demonstrates a complete post-training pipeline that takes a strong base coding model and aligns it to produce clean, maintainable, working code — not just code that passes tests.
